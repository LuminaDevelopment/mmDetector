...
public class PlayerESP {
    ...
    public void onRenderWorldLast(RenderWorldLastEvent event) {
        ...
        for (EntityPlayer player : mc.world.playerEntities) {
            ...
            if (PLAYERS_WITH_HIGHLIGHTED_ITEM.contains(player)) {
                ...
                drawOutlinedBoundingBox(player.getEntityBoundingBox(), 1.0F, 0.0F, 0.0F, 0.2F);
    ...
    public void onRenderLiving(RenderLivingEvent.Post event) {
        ...
        if (PLAYERS_WITH_HIGHLIGHTED_ITEM.contains(player)) {
            ...
            drawOutlinedBoundingBox(player.getEntityBoundingBox().grow(0.0, 0.0, 0.0).offset(0.0, -player.getEyeHeight(), 0.0), 1.0F, 0.0F, 0.0F, 0.2F);
        }
    }
    ...
    private void drawLineToEntity(Entity entity) {
        ...
        BufferBuilder buffer = tessellator.getBuffer();
        buffer.begin(GL11.GL_LINES, DefaultVertexFormats.POSITION_COLOR);
        buffer.pos(x, y, z).color(1.0F, 0.0F, 0.0F, 0.2F).endVertex();
        buffer.pos(entity.posX, entity.posY + entity.getEyeHeight(), entity.posZ).color(1.0F, 0.0F, 0.0F, 0.2F).endVertex();
        tessellator.draw();
    }
}
